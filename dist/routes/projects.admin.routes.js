...
// -------------------- routes --------------------
projectsAdminRouter.get("/admin/projects", asyncHandler(async (_req, res) => {
...
projectsAdminRouter.post("/admin/projects", validate(ProjectCreateSchema), asyncHandler(async (req, res) => {
    const data = req.body;
...
projectsAdminRouter.delete("/admin/projects/:id", asyncHandler(async (req, res) => {
    const deleted = await Project.findByIdAndDelete(req.params.id);
    if (!deleted)
        return res.status(404).json({ error: "Not found" });
    res.json({ ok: true });
}));
projectsAdminRouter.put("/admin/projects/:id", asyncHandler(async (req, res) => {
    const data = req.body;
